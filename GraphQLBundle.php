...
use Youshido\GraphQLBundle\DependencyInjection\Compiler\RegisterGraphQlListenersPass;
...
class GraphQLBundle extends Bundle
{
    public function build(ContainerBuilder $container): void
    {
        ...
        $container->addCompilerPass(new RegisterGraphQlListenersPass(), PassConfig::TYPE_BEFORE_REMOVING);
    }
